...
{
    public class BasketDeleteProvider : BaseBasketProvider, IProvider<BasketViewModel>
    {
        public void Execute(BasketViewModel model)
        {
            var url = $"{Config.DominosApiUrl}{Config.BasketServices.DeleteProductFromBasket}";
